...
//	connect( settingsButton, SIGNAL( clicked() ), this, SLOT( settings() ) );
	...
	sctp_error_bar -> setTotalSteps(error_threshold);
	sctp_error_bar -> setProgress(0);
...
void DrtaMW2::helpAbout()
{
	QMessageBox::about( this, "Dr.ta help" ,"<center><b>Dr.ta</b> means <b>\"Driving Talking\"</b>.</center><br>"
					 ...
					 "based on sctp protocol and IHU(http://ihu.sf.net),of MOD.<br>"
					 "It integrates the voice/text and <br>"
					 "supports multi-network communication.<br><br>"
					 "<center>http://mod.0rz.net/</center>"
					 "<center>http://drta.0RZ.NET/</center>" 
					 "Copyright (C) 2006 Kai-Fong Chou(maple). All rights reserved.<br>"
					 "Copyright (C) 2003-2005 Matteo Trotta. All rights reserved.<br>"
					 "Distributed under the terms of GNU General Public License.<br>"
					 "Using Speex v. 1.1.11 Copyright (C) Jean-Marc Valin.<br>"
					 "Using SoundTouch v.1.3.0 Copyright (C) Olli Parviainen.<br>"
					 );
}
